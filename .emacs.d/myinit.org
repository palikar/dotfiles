...
#+BEGIN_SRC emacs-lisp :results none
(defhydra arnaud-windowing (:color red
                               :hint nil)
  "
 ^Ace-window^
^^------------------------------------------------------------------
...
(define-key my-keys-mode-map (kbd "C-c h w") 'arnaud-windowing/body)
#+END_SRC
** Bookmarks navigation

#+BEGIN_SRC emacs-lisp
(defhydra arnaud-hydra-bookmarks (:color red
                              :hint nil)
  "
...
** Registers
#+BEGIN_SRC emacs-lisp :results none
(defhydra arnaud-hydra-registers (:color red
                              :hint nil)
  "
 ...
 _+_: increment  _p_: point-to   _h_: helm-register
  ...
  ("h" helm-register)
  ("q" nil :color blue))
(define-key my-keys-mode-map (kbd "C-c h C-r") 'arnaud-hydra-registers/body)
#+END_SRC
** Modes toggling
#+BEGIN_SRC emacs-lisp :results none
...
(define-key my-keys-mode-map (kbd "C-c h C-m") 'arnaud-hydra-active-modes/body)
#+END_SRC
** Org trees movement
#+BEGIN_SRC emacs-lisp :results none
...
(define-key my-keys-mode-map (kbd "C-c h o") 'arnaud-hydra-org-organize/body)
#+END_SRC
...
** Formatting
#+BEGIN_SRC emacs-lisp :results none
(defhydra arnaud-hydra-format (:color red
                               :hint nil)
  "
 ^Beautify^
^^^^^^^^^^--------------------------------------
