...
#+END_EXAMPLE
//
I've drawn a lot of inspiration for my Emacs configuration form [[https://github.com/zamansky/using-emacs][here]]
* Repos and packages
...
(define-key my-keys-mode-map [(control shift down)]  'duplicate-line)
(define-key my-keys-mode-map [(control shift up)]  'duplicate-line)   
#+END_SRC
