...
(when (load-if-present "/home/arnaud/code_ext/q4/q4.el")y
...
#+RESULTS:
| (lambda nil (org-bullets-mode 1) (flyspell-mode 1)) | #[0 \301\211\207 [imenu-create-index-function org-imenu-get-tree] 2] | er/add-org-mode-expansions | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | (lambda nil (if (member (quote (ein . python)) org-src-lang-modes) org-src-lang-modes (setq org-src-lang-modes (cons (quote (ein . python)) org-src-lang-modes))) (if (member (quote (ein-hy . hy)) org-src-lang-modes) org-src-lang-modes (setq org-src-lang-modes (cons (quote (ein-hy . hy)) org-src-lang-modes)))) | org-eldoc-load |
